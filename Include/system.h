/*
 *		$Archive: /video/Nba/Include/system.h $
 *		$Revision: 4 $
 *		$Date: 1/23/99 4:41a $
 *
...
char *ss_system_h = "$Workfile: system.h $ $Revision: 4 $";
#endif
...
//typedef signed long long llong;				/* a 64 bit interger*/
//typedef unsigned long long ullong;			/* an unsigned 64 bit integer */
