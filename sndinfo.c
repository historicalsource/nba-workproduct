...
#ifdef INCLUDE_SSID
char *ss_sndinfo_c = "$Workfile: sndinfo.c $ $Revision: 7 $";
#endif
...
void show_sound_version(float *y_pos)
{
	...
	{	
		...
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 120.0F);
		...
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 110.0f);
		...
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 100.0f);
		...
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 90.0f);
		...
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 80.0f);
		switch (sram_status) {
		...
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 70.0f);
		switch (dram_status) {
		...
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 60.0f);
	...
	{
		*y_pos -= sysfont_height;
		set_text_position(x_pos, *y_pos, 50.0f);
